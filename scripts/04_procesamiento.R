# =============================================================================
# SCRIPT 04: PROCESAMIENTO Y TRANSFORMACIONES
...
base_potencial_transformado <- base_potencial_transformado %>%
  mutate(log_fob_mundial = log(fob_mundial))
...
# Para tratamiento robusto de Outliers
...
# Paso B: Aplicar Winsorize usando pmin/pmax.
# Lo hicimos "manual" para no seguir peleando con errores al intentar usar lihbrerias complejas
